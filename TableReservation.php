	...
	<div class="order-section-page">
		<div class="ordering-form">
			...
			<div class="order-form-head text-center wow bounceInLeft" data-wow-delay="0.4s">
						...
						<p>Keep in mind, your table reservation is not complete until you receive a confirmation email.!!!</p>
					</div>
...
<div class="form-group">
  Branch:<br>
  <input type="radio" name="branch" value="kohuwala">Kohuwala<br>
  <input type="radio" name="branch" value="wijerama">Wijerama<br>
  <input type="radio" name="branch" value="walipanna">Walipanna<br>
  <input type="radio" name="branch" value="nugegoda">Nugegoda<br>
  ...
  <br><br>
  <div class="wow swing animated" data-wow-delay= "0.04s">
  <input class="btn btn-success" style=""type="submit" name="submit" value="Submit" > 
  </div> 
  <br><br>
</div>
</form>
				...
				<div class="col-md-6 ordering-image wow bounceIn" data-wow-delay="0.4s">
					<img src="images/table.jpg" class="img-responsive" alt="" />
