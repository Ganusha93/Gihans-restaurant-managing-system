	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				...
				<div class="queries">
					<p>Questions? Call us Toll-free!<label>(11AM to 11PM)</label></p>
				</div>
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <?php  while ($row = mysqli_fetch_assoc($res)) { ?>
						<h3><a href="#"><?php echo $row['foodname']; ?></a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p><?php echo $row['ordertype']; ?></p></li>
						</ul>
							 <div class="delivery">
